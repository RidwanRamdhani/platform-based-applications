...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const mahasiswaId = form.getAttribute('data-id');
    ...
    const loadDetail = async () => {
        try {
            ...
            if (!response.ok) {
                throw new Error('Gagal memuat detail mahasiswa.');
            }
    ...
    form.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                const message = err?.message || 'Gagal memperbarui mahasiswa.';
